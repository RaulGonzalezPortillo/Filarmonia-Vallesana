    ...
    resources: {
      en: {
        translation: {
          ...
          "content-achievements": "<strong>Other beneficiaries:<br /><br /></strong>The creation of Filarmonia jobs provides the opportunity for parents and students to be trained and occupy jobs in the program supporting their family economy.<br /><br /><strong>Achievements<br /><br /></strong>We are proud to recognize the individual growth of outstanding students in the world of music:<br /><br />&bull; Alumn@s selected to participate in the First Bandim<br />&bull; Iterlochen Summer Camp + orchestral conducting<br />&bull; International Congress of horn players in Ithaca, New York (2 students)<br />&bull; Korea Tour 2019 with Simanof Orchestral Foundation in the cities of Seoul, Chincheon and Yongin<br />&bull; Symphony Orchestras of the Superior Institute (ISMEV)<br />&bull; Camerata de Coahuila <br />&bull; Papakilistli Salsa Orchestra<br />&bull; Veracruzana University Big Band<br />&bull; Veracruz Trombone Ensemble<br />&bull; Support from Stuttgart Orchestra<br />&bull; Alumni ambassadors, academic council and representatives of Hundred Finland"
        }
      },
      es: {
        translation: {
