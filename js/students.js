    ...
    resources: {
      en: {
        translation: {
          ...
          "content-students": "<strong>Our focus is the personalized attention we provide to our students for their education and development.</strong><br/><br/>We provide them with basic tools for entrepreneurship and leadership, human development and emotional intelligence that will be reflected in their future life.<br /><br />We channel the talent and development of their skills, generating environments of social success both individually, family and community, satisfying the lack of cultural programs and family unity in the communities where the program is developed.<br /><br />Our Filarmonia Vallesana graduates (over 18 years old) continue with their studies in higher education in several states of the Mexican Republic, since in the communities where our programs are developed there are no institutions of higher education and the desertion at this stage of life of young people usually occurs to a large extent.",
      ...
      es: {
        translation: {
          ...
          "content-students": "<strong>Nuestro enfoque es la atenci&oacute;n personalizada que les brindamos a nuestros alumnos para su educaci&oacute;n y desarrollo.</strong><br/><br/>Se les dota de herramientas b&aacute;sicas de emprendimiento y de liderazgo, desarrollo humano e inteligencia emocional que se ver&aacute;n reflejadas en su vida futura. <br /><br />Canalizamos el talento y desarrollo de sus habilidades, generando entornos de &eacute;xito social tanto individual, familiar y comunitario, satisfaciendo la falta de programas culturales y de uni&oacute;n familiar en las comunidades donde se desarrolla el programa. <br /><br />Nuestros egresados del Filarmon&iacute;a Vallesana (mayores de 18 a&ntilde;os) contin&uacute;an con sus estudios en grados superiores en varios estados de la Rep&uacute;blica Mexicana, siendo que en las comunidades en las que se desarrollan nuestros programas no hay instituciones de estudios superiores y la deserci&oacute;n en esta etapa de la vida de los j&oacute;venes suele darse en gran medida.",
